...
const AddBrawlStars = () => {
    ...
    const usersCollectionRef = collection(db, 'usersbrawl')
    ...
    const createUser = async () => {
        ...
        const imageRef = ref(storage, `imgbrawl/${imageUpload.name + v4()}`)
            ...
            <h2>Brawl Stars</h2>
                ...
                <div className="row">
                    ...
                    <div className="inner-input">
                        ...
                        <input onChange={(e) => setTrofei(e.target.value)} type="text" />
                    </div>
                </div>
                <div className="row">
                    <div className="inner-input">
                        <label for="">Бравлеров</label>
                        <input onChange={(e) => setBrawler(e.target.value)} type="text" />
                    </div>
                    <div className="inner-input">
